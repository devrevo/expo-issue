...
const Images = {
  ...
  IconWishList: require("@images/icons/icon-turned.png"),
  IconCart: require("@images/icons/icon-library.png"),
  ...
  IconDeFlag: require("@images/de.png"),
  IconChFlag: require("@images/cn.png"),
  IconPoFlag: require("@images/pt.png"),
  IconRuFlag: require("@images/ru.png"),
  IconSpFlag: require("@images/es.png"),
  IconFrFlag: require("@images/mf.png"),
  IconArFlag: require("@images/sa.png"),
